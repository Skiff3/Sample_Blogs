use crate::model::models::{get_all_categories, get_details_of_post, GuestTemplate, PostTemplate};
use askama::Template;
use axum::{
    extract::Path,
    http::StatusCode,
...
pub async fn show_posts(Path(post_name): Path<String>) -> impl IntoResponse {
